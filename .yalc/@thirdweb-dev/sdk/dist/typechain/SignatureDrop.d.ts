...
export interface SignatureDropInterface extends utils.Interface {
    functions: {
        ...
        "initialize(address,string,string,string,address[],address,address,uint128,uint128,address,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "DEFAULT_ADMIN_ROLE" | "approve" | "balanceOf" | "burn" | "claim" | "claimCondition" | "contractType" | "contractURI" | "contractVersion" | "encryptDecrypt" | "encryptedBaseURI" | "getActiveClaimConditionId" | "getApproved" | "getBaseURICount" | "getBatchIdAtIndex" | "getClaimConditionById" | "getClaimTimestamp" | "getDefaultRoyaltyInfo" | "getPlatformFeeInfo" | "getRevealURI" | "getRoleAdmin" | "getRoleMember" | "getRoleMemberCount" | "getRoyaltyInfoForToken" | "grantRole" | "hasRole" | "hasRoleWithSwitch" | "initialize" | "isApprovedForAll" | "isEncryptedBatch" | "isTrustedForwarder" | "lazyMint" | "mintWithSignature" | "multicall" | "name" | "nextTokenIdToMint" | "owner" | "ownerOf" | "primarySaleRecipient" | "renounceRole" | "reveal" | "revokeRole" | "royaltyInfo" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "setClaimConditions" | "setContractURI" | "setDefaultRoyaltyInfo" | "setOwner" | "setPlatformFeeInfo" | "setPrimarySaleRecipient" | "setRoyaltyInfoForToken" | "sigMint" | "supportsInterface" | "symbol" | "tokenURI" | "totalSupply" | "transferFrom" | "verify" | "verifyClaim" | "verifyClaimMerkleProof"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "sigMint", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "sigMint", data: BytesLike): Result;
...
export interface SignatureDrop extends BaseContract {
    ...
    functions: {
        ...
        initialize(_defaultAdmin: string, _name: string, _symbol: string, _contractURI: string, _trustedForwarders: string[], _saleRecipient: string, _royaltyRecipient: string, _royaltyBps: BigNumberish, _platformFeeBps: BigNumberish, _platformFeeRecipient: string, _signatureMintLogic: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        sigMint(overrides?: CallOverrides): Promise<[string]>;
    ...
    callStatic: {
        ...
        hasRole(role: BytesLike, account: string, overrides?: CallOverrides): Promise<boolean>;
        hasRoleWithSwitch(role: BytesLike, account: string, overrides?: CallOverrides): Promise<boolean>;
        initialize(_defaultAdmin: string, _name: string, _symbol: string, _contractURI: string, _trustedForwarders: string[], _saleRecipient: string, _royaltyRecipient: string, _royaltyBps: BigNumberish, _platformFeeBps: BigNumberish, _platformFeeRecipient: string, _signatureMintLogic: string, overrides?: CallOverrides): Promise<void>;
        isApprovedForAll(owner: string, operator: string, overrides?: CallOverrides): Promise<boolean>;
        isEncryptedBatch(_batchId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
        isTrustedForwarder(forwarder: string, overrides?: CallOverrides): Promise<boolean>;
    ...
    estimateGas: {
        ...
        sigMint(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        sigMint(overrides?: CallOverrides): Promise<PopulatedTransaction>;
